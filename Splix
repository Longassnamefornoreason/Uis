...
local library = {
    ...
    folders = {
        main = "aristois",
        assets = "aristois/assets",
        configs = "aristois/configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
local theme = {
    ...
    light_contrast = Color3.fromRGB(30, 30, 36),
    dark_contrast = Color3.fromRGB(18, 18, 22),
...
do
    ...
    function library:New(info)
        ...
        function window:Watermark(info)
            ...
            --
            watermark_title.Text = string.format("Aristois || ping : %i || fps : %u", 1, tostring(library.shared.ping), library.shared.fps)
